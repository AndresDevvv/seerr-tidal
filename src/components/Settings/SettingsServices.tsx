...
const messages = defineMessages('components.Settings', {
  ...
  lidarrsettings: 'OrpheusDL / TIDAL Settings',
  ...
  musicServiceSettingsDescription:
    'Configure your {serverType} service(s) below. Music approvals run through a bundled OrpheusDL checkout using the TIDAL module, with the selected default quality and download path.',
  ...
  addlidarr: 'Add OrpheusDL Service',
  noDefaultServer:
            ...
            <ul className="grid max-w-6xl grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
              {lidarrData.map((lidarr) => (
                <ServerInstance
                  ...
                  addressLabel={lidarr.workingDirectory}
