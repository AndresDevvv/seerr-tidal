...
import {
  ...
  DEFAULT_ORPHEUS_EXECUTABLE,
  DEFAULT_ORPHEUS_SCRIPT,
...
class Settings {
  ...
  constructor(initialSettings?: AllSettings) {
    ...
    if (this.data.lidarr.length === 0) {
      this.data.lidarr = [
        {
          id: 0,
          name: 'OrpheusDL (TIDAL)',
          hostname: '',
          port: 0,
          apiKey: '',
          useSsl: false,
          ...
          activeDirectory: DEFAULT_ORPHEUS_DOWNLOAD_DIR,
          tags: [],
          is4k: false,
          isDefault: true,
          syncEnabled: false,
          ...
          tagRequests: false,
          overrideRule: [],
          workingDirectory: DEFAULT_ORPHEUS_WORKDIR,
          scriptPath: DEFAULT_ORPHEUS_SCRIPT,
          executablePath: DEFAULT_ORPHEUS_EXECUTABLE,
          moduleName: 'tidal',
        },
      ];
    }
